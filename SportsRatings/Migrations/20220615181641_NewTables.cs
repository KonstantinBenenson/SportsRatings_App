            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    MechanicsRate = table.Column<double>(type: "float", nullable: false),
                    MentalityRate = table.Column<double>(type: "float", nullable: false),
                    TeamWorkRate = table.Column<double>(type: "float", nullable: false),
